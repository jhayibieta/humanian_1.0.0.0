...
<body id="top">
    ...
    <?php 
        ...
        include("../connect.php");
            ...
            $overtime = $connect->query("SELECT * FROM tblhrconcern WHERE hrcId = '" . $_GET['$id'] . "'");

            while($row = $overtime->fetch_array()){
                $id = $row['userId'];
                $reason = $row['hrcContent'];
                $status = $row['hrcStatus'];
            ...
            <div class="container" id="dashboard-container">
                ...
                <div class="row">
                    <div class="col-md-8 lg-8 sm-8">
                        ...
                        <div class="panel" style="height:300px;box-shadow: 0px 0px 17px 0px #ccc;">
                             <h5 class="text-left" id="card-header">EMPLOYEE'S CONCERN:</h5><hr/>
                ...
                <div class="row">
                    <div class="col-md-2 lg-2 sm-2">
                        <a href="resolve-hr-concern.php?$id=<?php echo $_GET['$id'];?>" class="btn btn-block btn-success" style="background-color: #008076;border-radius:25px;font-weight: bold;">RESOLVED</a>
                    </div>
                    <div class="col-md-2 lg-2 sm-2">
                        <a href="on-hold-hr-concern.php?$id=<?php echo $_GET['$id'];?>" class="btn btn-block btn-warning" style="border-radius:25px;font-weight: bold;">ON-HOLD</a>
