...
<body id="top">
    ...
    <?php 
      ...
      $details = $connect->query("SELECT * FROM tbldetails WHERE userId = '$id'");
            ...
            <div class="container" id="dashboard-container">
                ...
                <div class="row">
                    <div class="col-md-8 lg-8 sm-8">
                        ...
                        <div class="panel" style="height:300px;box-shadow: 0px 0px 17px 0px #ccc;">
                             <h5 class="text-left" id="card-header">EMPLOYEE'S BASIC INFO:</h5><hr/>
                        ...
                        <div class="panel" style="height:420px;box-shadow: 0px 0px 17px 0px #ccc;">
                          <h5 class="text-left" id="card-header">201 FILE RECORDS:</h5><hr/>
                              <div class="container-fluid">
                               ...
                               <p class="text-left">PHIL HEALT : </p>   
                ...
                <div class="row">
                    <div class="col-md-2 lg-2 sm-2">
                        <a href="resolve-hr-concern.php?$id=<?php echo $_GET['$id'];?>" class="btn btn-block btn-success" style="background-color: #008076;border-radius:25px;font-weight: bold;">ACTIVATE</a>
                    </div>
                    <div class="col-md-2 lg-2 sm-2">
